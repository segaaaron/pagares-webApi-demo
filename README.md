...
```bash
pnpm verify         # 374 unitarias + lint + typecheck + arquitectura
pnpm test:e2e       # 109 contra la API real: e2e, seguridad, concurrencia y contrato
pnpm test:a11y      # 17 de navegador: accesibilidad y flujos del panel
